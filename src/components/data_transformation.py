...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Checking unique values in categorical columns:")
            logging.info(f"Unique values in Education: {input_feature_train_df['Education'].unique()}")
            logging.info(f"Unique values in Marital_Status: {input_feature_train_df['Marital_Status'].unique()}")
            ...
            logging.error('Exception occurred in the initiate data transformation process')
            raise CustomException(e, sys)
